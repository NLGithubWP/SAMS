...
for dataset, valuedic in frappe_datasets_result.items():
    ...
    ax.bar(index + bar_width / 2, in_db_data_query + in_db_data_copy_start_py + in_db_data_preprocess+in_db_data_compute,
           ...
           label=ouy_system, edgecolor='black')
    ...
    set_label_baseline_sys = False
    set_ouy_system = False
...
fig.savefig(f"./internal/ml/model_slicing/In_DB_inference/macro_data_scale_sys.pdf",
            bbox_inches='tight')
