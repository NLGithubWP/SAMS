...
fig.tight_layout()
# plt.show()
print(f"saving to ./internal/ml/model_slicing/In_DB_inference/int_format/macro_data_scale.pdf")
fig.savefig(f"./internal/ml/model_slicing/In_DB_inference/int_format/macro_data_scale_sys.pdf",
            bbox_inches='tight')
